...
//go:generate mockgen -package clientmock -destination=./client_mock/candhis_sessionid_web_scraper.go -source=candhis_sessionid_web_scraper.go CandhisSessionIDWebScraper
