...
//go:generate mockgen -package clientmock -destination=./client_mock/candhis_web_scraper.go -source=candhis_web_scraper.go CandhisWebScraper
type CandhisWebScraper interface {
