...
type candhisWebScrapper struct {
	client *http.Client
}

func NewCandhisWebScrapper(client *http.Client) *candhisWebScrapper {
	return &candhisWebScrapper{client}
}

func (c *candhisWebScrapper) GatherWaveDataFromWebTable(phpsessid, candhisURL string) ([]model.WaveData, error) {
...
func (c *candhisWebScrapper) parseRowOfWebTable(cells *goquery.Selection) (model.WaveData, error) {
