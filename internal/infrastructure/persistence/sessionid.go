...
func NewSessionIDStore(dbConn *sql.DB) *sessionIDStore {
	return &sessionIDStore{
		dbConn: dbConn,
	}
}

func (r *sessionIDStore) Get(ctx context.Context) (*model.CandhisSessionID, error) {
...
func (r *sessionIDStore) Update(ctx context.Context, sessionID *model.CandhisSessionID) error {
